...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_1[MY_DISP_HOR_RES*10];   //MY_DISP_HOR_RES * MY_DISP_VER_RES/ 30 /*A buffer for 10 rows*/ //[MY_DISP_HOR_RES * 10]
...
//                          MY_DISP_VER_RES * LV_VER_RES_MAX);   /*Initialize the display buffer*/
  ...
  //  static lv_disp_drv_init(&disp_drv);                    /*Basic initialization*/
